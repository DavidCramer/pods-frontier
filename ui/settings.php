...
echo caldera_configOption('ID', 'ID', 'hidden', 'ID', $podTemplate);
echo caldera_configOption('name', 'name', 'textfield', 'Template Name', $podTemplate);
echo caldera_configOption('description', 'description', 'textarea', 'Template Description', $podTemplate);
//echo caldera_configOption('category', 'category', 'textfield', 'Category', $podTemplate, false, 'autocomplete="off"');
echo caldera_configOption('slug', 'slug', 'textfield', 'Slug / Shortcode', $podTemplate);

echo '<div class="caldera_configOption podselect" id="config_pod">';
...
function caldera_reloadHelp(eid){
