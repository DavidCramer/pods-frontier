        ...
        echo '<div class="displaypods-wrap">';
            ...
            echo '<div id="side-controls" class="side-controls">';
                ...
                echo '<ul class="element-config-tabs navigation-tabs">';
                    echo '<li class="trigger active" data-request="panelTab" data-group="leftnav"><a title="Builder" href="#builder-tab" class="control-builder-icon"><span>Builder</span></a></li>';
                    //echo '<li class="trigger" data-request="panelTab" data-group="leftnav"><a title="Settings" href="#config-tab" class="control-settings-icon"><span>Settings</span></a></li>';
                    echo '<li class="trigger" data-request="panelTab" data-group="leftnav"><a title="Processors" href="#processors-tab" class="control-processors-icon active"><span>Processors</span></a></li>';
                echo '</ul>';
            echo '</div>';
            ...
            echo '<div class="editor-pane">';
                ...
                */
                // processors tab
                echo '<div class="editor-panel settings-panel hide" id="processors-tab">';
